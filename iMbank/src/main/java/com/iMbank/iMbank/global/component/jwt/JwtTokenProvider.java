...
import com.iMbank.iMbank.global.component.jwt.exception.JwtTokenErrorCode;
import com.iMbank.iMbank.global.component.jwt.exception.JwtTokenException;
...
public class JwtTokenProvider {
    ...
    public String issueAccessToken(Member member) {
        ...
        Claims claims = Jwts.claims()
                ...
                .build();
        Duration expiration = tokenPropsInfo.accessExpiration();
        if (expiration == null) {
            // Log a warning if expiration is null
            log.warn("Access expiration duration is null");
        }
